    ...
    public RegisterPanel(JFrame parentFrame) {
        ...
        btnRegistrati.addActionListener(e -> {
            ...
            try {
                ...
                RegistrazioneEsito esito =
                        controller.registrati(username, password, nome, cognome, ruolo);

                switch (esito) {
                    case SUCCESSO -> {
                        JOptionPane.showMessageDialog(
                                this, "Registrazione completata!", "Successo",
                                JOptionPane.INFORMATION_MESSAGE
                        );
                        // Torna alla home della finestra esistente (N O N creare una nuova MainWindow)
